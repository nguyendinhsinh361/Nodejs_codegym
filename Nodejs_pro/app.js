...
// Phân tích chuỗi JSON bằng cách đọc nó và lưu vào biến vehiclePlates
let vehiclePlates = JSON.parse(fs.readFileSync(__dirname + "/vehicle_plates.json"));
let idx = 1;
